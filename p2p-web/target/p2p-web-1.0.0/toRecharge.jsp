        ...
        function submitForm() {
            ...
            if (checkData()) {
                ...
                if ("alipay" == payType) {
                    ...
                    $("#wxRechargeMoney").val(rechargeMoney);
                ...
                <c:if test="${!empty user.name}">
                    <div class="payInvest" style="display:block;">
                        <div class="investMain">
                            ...
                            <div class="investContent">
                                ...
                                <div class="investOver clearfix" id="banks2">
                                    <form id="alipayRechargeForm"
                                          action="${pageContext.request.contextPath}/loan/toAlipayRecharge"
                                    ...
                                    <form id="wxpayRechargeForm"
                                          action="${pageContext.request.contextPath}/loan/toWxpayRecharge" method="post"
                                          target="_blank">
                                        <input type="hidden" id="wxRechargeMoney" name="rechargeMoney" value=""/>
                                    </form>
                                    <label>
                        ...
                        <div class="investFooter clearfix">
                            <h3>请输入充值金额</h3>
                            <div class="inputTxt">
                                <input type="text" name="rechargeMoney" id="rechargeMoney" value="" class="input_text"
                                       onblur="checkData()"/>
