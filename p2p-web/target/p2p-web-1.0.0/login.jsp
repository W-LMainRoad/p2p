    ...
    <div class="homeWap">
      <div class="login-cnt clearfix">
        <div class="login-form">
		     ...
		     <label>密码</label>
		     	<input id="loginPassword" name="loginPassword" type="password" placeholder="请输入登录密码" class="input_text" maxlength="16" onblur="checkPassword();"/>
		     </div>
        ...
        <div class="login-right">
          ...
          <div class="top-txt">
		          动力金融网，便捷的投资平台
			<br/><br/>
			加入动力金融网<br/>坐享${historyAverageRate}%历史年化收益
          </div>
           
          <div class="currently">
          	平台用户数：<span id="user">${allUserCount}</span>位，累计成交额： <span id="gold">${allBidMoney}</span>元
          </div>
