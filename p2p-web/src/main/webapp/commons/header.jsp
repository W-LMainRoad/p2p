        ...
        <div class="login-right">
            <c:choose>
                <c:when test="${empty user}">
                    <!-- 未登录start -->
                    <div class="no-login"><a href="${pageContext.request.contextPath}/register.jsp" class="btn-reg">注册</a><a href="${pageContext.request.contextPath}/loan/loginInfo" class="btn-login">登录</a></div>
                    <!-- 未登录end -->
                </c:when>
                <c:otherwise>
                    <!--登录后begin-->
